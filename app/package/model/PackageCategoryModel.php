...
//        }
        ...
        foreach ($categories as $item) {
            ...
            $item['url']            = cmf_url('package/List/index', ['id' => $item['id']]);
    ...
    public function addCategory($data) {
        ...
        //         $routeModel->setRoute($data['alias'], 'package/List/index', ['id' => $id], 2, 5000);
        //         $routeModel->setRoute($data['alias'] . '/:id', 'package/Article/index', ['cid' => $id], 2, 4999);
        //     }
    ...
    public function editCategory($data) {
        ...
        if (empty($oldCategory) || empty($newPath)) {
            ...
            // $routeModel = new RouteModel();
            // if (!empty($data['alias'])) {
            //     $routeModel->setRoute($data['alias'], 'package/List/index', ['id' => $data['id']], 2, 5000);
            //     $routeModel->setRoute($data['alias'] . '/:id', 'package/Article/index', ['cid' => $data['id']], 2, 4999);
            // } else {
            //     $routeModel->deleteRoute('package/List/index', ['id' => $data['id']]);
            //     $routeModel->deleteRoute('package/Article/index', ['cid' => $data['id']]);
            // }
